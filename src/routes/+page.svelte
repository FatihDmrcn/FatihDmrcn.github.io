...
<PageContainer id={"about_me"}>
    ...
    >
        <CardContainer id={"about_me_0"} title={"Who I am"}>
        ...
        <CardContainer id={"about_me_1"} title={"What I use"}>
            <ul class="list">
                <li class="list-row">
                    Applications
        ...
        <CardContainer id={"about_me_2"} title={"My background"}>
